...
# export ORDERER_GENERAL_LISTENADDRESS=192.168.0.151
...
# export ORDERER_ADMIN_LISTENADDRESS=192.168.0.151:7053
# export ORDERER_OPERATIONS_LISTENADDRESS=192.168.0.151:9443
...
export CORE_PEER_LISTENADDRESS=192.168.0.153:7051
export CORE_PEER_CHAINCODEADDRESS=192.168.0.153:7052
export CORE_PEER_CHAINCODELISTENADDRESS=192.168.0.153:7052
export CORE_PEER_GOSSIP_BOOTSTRAP=192.168.0.153:7051
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=192.168.0.153:7051
...
export CORE_OPERATIONS_LISTENADDRESS=192.168.0.153:9444
