...
export ORDERER_GENERAL_LISTENADDRESS=1.1.1.1
...
export ORDERER_ADMIN_LISTENADDRESS=1.1.1.1:7053
export ORDERER_OPERATIONS_LISTENADDRESS=1.1.1.1:9443
...
export CORE_PEER_ADDRESS=1.1.1.1:7051
export CORE_PEER_LISTENADDRESS=1.1.1.1:7051
export CORE_PEER_CHAINCODEADDRESS=1.1.1.1:7052
export CORE_PEER_CHAINCODELISTENADDRESS=1.1.1.1:7052
export CORE_PEER_GOSSIP_BOOTSTRAP=1.1.1.1:7051
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=1.1.1.1:7051
...
export CORE_OPERATIONS_LISTENADDRESS=1.1.1.1:9444
